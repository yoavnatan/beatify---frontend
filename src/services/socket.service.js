...
export const SOCKET_EVENT_ON_SHUFFLE = 'on-shuffle'
export const SOCKET_EVENT_OFF_SHUFFLE = 'off-shuffle'
export const SOCKET_EMIT_ON_SHUFFLE = 'emit-on-shuffle'
export const SOCKET_EMIT_OFF_SHUFFLE = 'emit-off-shuffle'
export const SOCKET_EVENT_ON_LOOP = 'on-loop'
export const SOCKET_EVENT_OFF_LOOP = 'off-loop'
export const SOCKET_EMIT_ON_LOOP = 'emit-on-loop'
export const SOCKET_EMIT_OFF_LOOP = 'emit-off-loop'
